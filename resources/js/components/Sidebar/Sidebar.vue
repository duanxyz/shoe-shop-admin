            ...
            >
                ...
                >
                    <li class="items-center">
                        ...
                        >
                            <i
                                class="fas fa-fingerprint text-gray-400 mr-2 text-sm"
                            ></i>
                            Login
                        </a>
                    </li>
                ...
                >
                    <li class="items-center">
                        ...
                        >
                            <i
                                class="fas fa-newspaper text-gray-400 mr-2 text-sm"
                            ></i>
                            Landing Page
                        </a>
                    </li>
                    ...
                    <li class="items-center">
                        ...
                        >
                            <i
                                class="fas fa-user-circle text-gray-400 mr-2 text-sm"
                            ></i>
                            Profile Page
                        </a>
                    </li>
                ...
                >
                    ...
                    <li class="inline-flex">
                        ...
                        >
                            <i
                                class="fab fa-css3-alt mr-2 text-gray-400 text-base"
                            ></i>
                            CSS Components
                        </a>
                    </li>
                    ...
                    <li class="inline-flex">
                        ...
                        >
                            <i
                                class="fab fa-angular mr-2 text-gray-400 text-base"
                            ></i>
                            Angular
                        </a>
                    </li>
                    ...
                    <li class="inline-flex">
                        ...
                        >
                            <i
                                class="fab fa-js-square mr-2 text-gray-400 text-base"
                            ></i>
                            Javascript
                        </a>
                    </li>
                    ...
                    <li class="inline-flex">
                        ...
                        >
                            <i
                                class="fab fa-react mr-2 text-gray-400 text-base"
                            ></i>
                            NextJS
                        </a>
                    </li>
                    ...
                    <li class="inline-flex">
                        ...
                        >
                            <i
                                class="fas fa-link mr-2 text-gray-400 text-base"
                            ></i>
                            Svelte
                        </a>
                    </li>
                    ...
                    <li class="inline-flex">
                        ...
                        >
                            <i
                                class="fab fa-vuejs mr-2 text-gray-400 text-base"
                            ></i>
                            VueJS
                        </a>
                    </li>
